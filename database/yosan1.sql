...
<head>
  ...
  <link rel="shortcut icon" href="favicon.ico" type="image/x-icon">
    ...
    <link rel="stylesheet" type="text/css" href="./themes/pmahomme/css/theme.css?v=5.1.3&nocache=3648901453ltr&server=1">
...
<body>
  ...
  <div class="pma_quick_warp"><div class="drop_list"><button title="Tabel terakhir" class="drop_button btn">Terbaru</button><ul id="pma_recent_list"><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=perpustakaan1&table=peminjaman">`perpustakaan1`.`peminjaman`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=perpustakaan1&table=anggota">`perpustakaan1`.`anggota`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=kepegawaian&table=bagian">`kepegawaian`.`bagian`</a></li></ul></div><div class="drop_list"><button title="Tabel favorit" class="drop_button btn">Favorit</button><ul id="pma_favorite_list"><li class="warp_link">Tidak ada tabel favorit terbaru.</li></ul></div><div class="clearfloat"></div></div>
  ...
  <div id="pma_console_container">
    <div id="pma_console">
                ...
                <div class="message welcome">
                    ...
                    <span class="hide" id="instructions-1">
                        Press Enter to execute query                    </span>
                            ...
                            targetdb="pet_shop_db" targettable="cart">
            ...
            Waktu eksekusi kueri
                            ...
                            <span class="query">SELECT * FROM `cart`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="pet_shop_db" targettable="categories">
                            <div class="action_content">
                    <span class="action collapse">
            Tampilkan
                    </span>
