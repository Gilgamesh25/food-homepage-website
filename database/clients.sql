...
<head>
  ...
  <link rel="shortcut icon" href="favicon.ico" type="image/x-icon">
    ...
    <link rel="stylesheet" type="text/css" href="./themes/pmahomme/css/theme.css?v=5.1.3&nocache=1130407970ltr&server=1">
...
<body>
  ...
  <div class="pma_quick_warp"><div class="drop_list"><button title="Tabel terakhir" class="drop_button btn">Terbaru</button><ul id="pma_recent_list"><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=pet_shop_db&table=inventory">`pet_shop_db`.`inventory`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=pet_shop_db&table=clients">`pet_shop_db`.`clients`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=perpustakaan1&table=peminjaman">`perpustakaan1`.`peminjaman`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=perpustakaan1&table=anggota">`perpustakaan1`.`anggota`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=kepegawaian&table=bagian">`kepegawaian`.`bagian`</a></li></ul></div><div class="drop_list"><button title="Tabel favorit" class="drop_button btn">Favorit</button><ul id="pma_favorite_list"><li class="warp_link">Tidak ada tabel favorit terbaru.</li></ul></div><div class="clearfloat"></div></div>
...
<div id='pma_navigation_tree_content'>
  <ul>
    <li class="first new_database italics"><div class='block'><i class='first'></i></div><div class="block second"><a href='index.php?route=/server/databases&server=1'><img src="themes/dot.gif" title="" alt="" class="icon ic_b_newdb"></a></div><a class='hover_show_full' href='index.php?route=/server/databases&server=1' title='Baru'>Baru</a><div class="clearfloat"></div></li><li class="database"><div class='block'><i></i><b></b><a class="expander" href='#'><span class="hide paths_nav" data-apath="cm9vdA==.YWthZGVtaWs=" data-vpath="cm9vdA==.YWthZGVtaWs=" data-pos="0"></span><img src="themes/dot.gif" title="Bentangkan/Tutup" alt="Bentangkan/Tutup" class="icon ic_b_plus"></a></div><div class="block second"><a href='index.php?route=/database/operations&amp;server=1&amp;db=akademik&amp;'><img src="themes/dot.gif" title="Operasi database" alt="Operasi database" class="icon ic_s_db"></a></div><a class='hover_show_full' href='index.php?route=/database/structure&server=1&amp;db=akademik' title='Struktur'>akademik</a><div class="clearfloat"></div></li><li class="database"><div class='block'><i></i><b></b><a class="expander" href='#'><span class="hide paths_nav" data-apath="cm9vdA==.ZGJfc2lwZW5qYWx1" data-vpath="cm9vdA==.ZGJfc2lwZW5qYWx1" data-pos="0"></span><img src="themes/dot.gif" title="Bentangkan/Tutup" alt="Bentangkan/Tutup" class="icon ic_b_plus"></a></div><div class="block second"><a href='index.php?route=/database/operations&amp;server=1&amp;db=db_sipenjalu&amp;'><img src="themes/dot.gif" title="Operasi database" alt="Operasi database" class="icon ic_s_db"></a></div><a class='hover_show_full' href='index.php?route=/database/structure&server=1&amp;db=db_sipenjalu' title='Struktur'>db_sipenjalu</a><div class="clearfloat"></div></li><li class="database"><div class='block'><i></i><b></b><a class="expander" href='#'><span class="hide paths_nav" data-apath="cm9vdA==.aW5mb3JtYXRpb25fc2NoZW1h" data-vpath="cm9vdA==.aW5mb3JtYXRpb25fc2NoZW1h" data-pos="0"></span><img src="themes/dot.gif" title="Bentangkan/Tutup" alt="Bentangkan/Tutup" class="icon ic_b_plus"></a></div><div class="block second"><a href='index.php?route=/database/operations&amp;server=1&amp;db=information_schema&amp;'><img src="themes/dot.gif" title="Operasi database" alt="Operasi database" class="icon ic_s_db"></a></div><a class='hover_show_full' href='index.php?route=/database/structure&server=1&amp;db=information_schema' title='Struktur'>information_schema</a><div class="clearfloat"></div></li><li class="database"><div class='block'><i></i><b></b><a class="expander" href='#'><span class="hide paths_nav" data-apath="cm9vdA==.bWFoYXNpc3dh" data-vpath="cm9vdA==.bWFoYXNpc3dh" data-pos="0"></span><img src="themes/dot.gif" title="Bentangkan/Tutup" alt="Bentangkan/Tutup" class="icon ic_b_plus"></a></div><div class="block second"><a href='index.php?route=/database/operations&amp;server=1&amp;db=mahasiswa&amp;'><img src="themes/dot.gif" title="Operasi database" alt="Operasi database" class="icon ic_s_db"></a></div><a class='hover_show_full' href='index.php?route=/database/structure&server=1&amp;db=mahasiswa' title='Struktur'>mahasiswa</a><div class="clearfloat"></div></li><li class="database"><div class='block'><i></i><b></b><a class="expander" href='#'><span class="hide paths_nav" data-apath="cm9vdA==.bXlzcWw=" data-vpath="cm9vdA==.bXlzcWw=" data-pos="0"></span><img src="themes/dot.gif" title="Bentangkan/Tutup" alt="Bentangkan/Tutup" class="icon ic_b_plus"></a></div><div class="block second"><a href='index.php?route=/database/operations&amp;server=1&amp;db=mysql&amp;'><img src="themes/dot.gif" title="Operasi database" alt="Operasi database" class="icon ic_s_db"></a></div><a class='hover_show_full' href='index.php?route=/database/structure&server=1&amp;db=mysql' title='Struktur'>mysql</a><div class="clearfloat"></div></li><li class="database"><div class='block'><i></i><b></b><a class="expander" href='#'><span class="hide paths_nav" data-apath="cm9vdA==.cGVuZ2FkdWFu" data-vpath="cm9vdA==.cGVuZ2FkdWFu" data-pos="0"></span><img src="themes/dot.gif" title="Bentangkan/Tutup" alt="Bentangkan/Tutup" class="icon ic_b_plus"></a></div><div class="block second"><a href='index.php?route=/database/operations&amp;server=1&amp;db=pengaduan&amp;'><img src="themes/dot.gif" title="Operasi database" alt="Operasi database" class="icon ic_s_db"></a></div><a class='hover_show_full' href='index.php?route=/database/structure&server=1&amp;db=pengaduan' title='Struktur'>pengaduan</a><div class="clearfloat"></div></li><li class="database"><div class='block'><i></i><b></b><a class="expander" href='#'><span class="hide paths_nav" data-apath="cm9vdA==.cGVyZm9ybWFuY2Vfc2NoZW1h" data-vpath="cm9vdA==.cGVyZm9ybWFuY2Vfc2NoZW1h" data-pos="0"></span><img src="themes/dot.gif" title="Bentangkan/Tutup" alt="Bentangkan/Tutup" class="icon ic_b_plus"></a></div><div class="block second"><a href='index.php?route=/database/operations&amp;server=1&amp;db=performance_schema&amp;'><img src="themes/dot.gif" title="Operasi database" alt="Operasi database" class="icon ic_s_db"></a></div><a class='hover_show_full' href='index.php?route=/database/structure&server=1&amp;db=performance_schema' title='Struktur'>performance_schema</a><div class="clearfloat"></div></li><li class="database"><div class='block'><i></i><b></b><a class="expander" href='#'><span class="hide paths_nav" data-apath="cm9vdA==.cGVycHV0YWthYW4=" data-vpath="cm9vdA==.cGVycHV0YWthYW4=" data-pos="0"></span><img src="themes/dot.gif" title="Bentangkan/Tutup" alt="Bentangkan/Tutup" class="icon ic_b_plus"></a></div><div class="block second"><a href='index.php?route=/database/operations&amp;server=1&amp;db=perputakaan&amp;'><img src="themes/dot.gif" title="Operasi database" alt="Operasi database" class="icon ic_s_db"></a></div><a class='hover_show_full' href='index.php?route=/database/structure&server=1&amp;db=perputakaan' title='Struktur'>perputakaan</a><div class="clearfloat"></div></li><li class="database"><div class='block'><i></i><b></b><a class="expander" href='#'><span class="hide paths_nav" data-apath="cm9vdA==.cGV0X3Nob3BfZGI=" data-vpath="cm9vdA==.cGV0X3Nob3BfZGI=" data-pos="0"></span><img src="themes/dot.gif" title="Bentangkan/Tutup" alt="Bentangkan/Tutup" class="icon ic_b_plus"></a></div><div class="block second"><a href='index.php?route=/database/operations&amp;server=1&amp;db=pet_shop_db&amp;'><img src="themes/dot.gif" title="Operasi database" alt="Operasi database" class="icon ic_s_db"></a></div><a class='hover_show_full' href='index.php?route=/database/structure&server=1&amp;db=pet_shop_db' title='Struktur'>pet_shop_db</a><div class="clearfloat"></div></li><li class="database"><div class='block'><i></i><b></b><a class="expander" href='#'><span class="hide paths_nav" data-apath="cm9vdA==.cGhwbXlhZG1pbg==" data-vpath="cm9vdA==.cGhwbXlhZG1pbg==" data-pos="0"></span><img src="themes/dot.gif" title="Bentangkan/Tutup" alt="Bentangkan/Tutup" class="icon ic_b_plus"></a></div><div class="block second"><a href='index.php?route=/database/operations&amp;server=1&amp;db=phpmyadmin&amp;'><img src="themes/dot.gif" title="Operasi database" alt="Operasi database" class="icon ic_s_db"></a></div><a class='hover_show_full' href='index.php?route=/database/structure&server=1&amp;db=phpmyadmin' title='Struktur'>phpmyadmin</a><div class="clearfloat"></div></li><li class="database"><div class='block'><i></i><b></b><a class="expander" href='#'><span class="hide paths_nav" data-apath="cm9vdA==.dGVzdA==" data-vpath="cm9vdA==.dGVzdA==" data-pos="0"></span><img src="themes/dot.gif" title="Bentangkan/Tutup" alt="Bentangkan/Tutup" class="icon ic_b_plus"></a></div><div class="block second"><a href='index.php?route=/database/operations&amp;server=1&amp;db=test&amp;'><img src="themes/dot.gif" title="Operasi database" alt="Operasi database" class="icon ic_s_db"></a></div><a class='hover_show_full' href='index.php?route=/database/structure&server=1&amp;db=test' title='Struktur'>test</a><div class="clearfloat"></div></li><li class="database"><div class='block'><i></i><b></b><a class="expander" href='#'><span class="hide paths_nav" data-apath="cm9vdA==.d2FybWluZG9feW9zYW4=" data-vpath="cm9vdA==.d2FybWluZG9feW9zYW4=" data-pos="0"></span><img src="themes/dot.gif" title="Bentangkan/Tutup" alt="Bentangkan/Tutup" class="icon ic_b_plus"></a></div><div class="block second"><a href='index.php?route=/database/operations&amp;server=1&amp;db=warmindo_yosan&amp;'><img src="themes/dot.gif" title="Operasi database" alt="Operasi database" class="icon ic_s_db"></a></div><a class='hover_show_full' href='index.php?route=/database/structure&server=1&amp;db=warmindo_yosan' title='Struktur'>warmindo_yosan</a><div class="clearfloat"></div></li><li class="database"><div class='block'><i></i><b></b><a class="expander" href='#'><span class="hide paths_nav" data-apath="cm9vdA==.d2FydW5n" data-vpath="cm9vdA==.d2FydW5n" data-pos="0"></span><img src="themes/dot.gif" title="Bentangkan/Tutup" alt="Bentangkan/Tutup" class="icon ic_b_plus"></a></div><div class="block second"><a href='index.php?route=/database/operations&amp;server=1&amp;db=warung&amp;'><img src="themes/dot.gif" title="Operasi database" alt="Operasi database" class="icon ic_s_db"></a></div><a class='hover_show_full' href='index.php?route=/database/structure&server=1&amp;db=warung' title='Struktur'>warung</a><div class="clearfloat"></div></li><li class="last database"><div class='block'><i></i><a class="expander" href='#'><span class="hide paths_nav" data-apath="cm9vdA==.eW9zYW4=" data-vpath="cm9vdA==.eW9zYW4=" data-pos="0"></span><img src="themes/dot.gif" title="Bentangkan/Tutup" alt="Bentangkan/Tutup" class="icon ic_b_plus"></a></div><div class="block second"><a href='index.php?route=/database/operations&amp;server=1&amp;db=yosan&amp;'><img src="themes/dot.gif" title="Operasi database" alt="Operasi database" class="icon ic_s_db"></a></div><a class='hover_show_full' href='index.php?route=/database/structure&server=1&amp;db=yosan' title='Struktur'>yosan</a><div class="clearfloat"></div></li>
  </ul>
</div>
  ...
  <input type="hidden" name="tab_hash" value="">
    ...
    <input type="hidden" name="token" value="675f7e342e6e5d4b6341505147776c56">
    ...
    <div id="pma_console">
                ...
                <div class="message welcome">
                    ...
                    <span class="hide" id="instructions-1">
                        Press Enter to execute query                    </span>
                            ...
                            targetdb="pet_shop_db" targettable="products">
            ...
            Waktu eksekusi kueri
                            ...
                            <span class="query">SELECT * FROM `products`</span>
                                            ...
                                            <div class="message history collapsed hide select"
                            targetdb="pet_shop_db" targettable="sales">
                            <div class="action_content">
                    <span class="action collapse">
            Tampilkan
                    </span>
            ...
            Waktu eksekusi kueri
                            ...
                            <span class="query">SELECT * FROM `sales`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="pet_shop_db" targettable="inventory">
                            <div class="action_content">
                    <span class="action collapse">
            Tampilkan
                    </span>
            ...
            Waktu eksekusi kueri
                            ...
                            <span class="query">SELECT * FROM `inventory`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="pet_shop_db" targettable="system_info">
                            <div class="action_content">
                    <span class="action collapse">
            Tampilkan
                    </span>
            ...
            Waktu eksekusi kueri
                            ...
                            <span class="query">SELECT * FROM `system_info`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="pet_shop_db" targettable="sizes">
                            <div class="action_content">
                    <span class="action collapse">
            Tampilkan
                    </span>
            ...
            Waktu eksekusi kueri
                            ...
                            <span class="query">SELECT * FROM `sizes`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="pet_shop_db" targettable="sales">
                            <div class="action_content">
            ...
            Waktu eksekusi kueri
                            ...
                            <span class="query">SELECT * FROM `products`</span>
                                            ...
                                            <div class="message history collapsed hide select"
                            targetdb="pet_shop_db" targettable="order_list">
                            <div class="action_content">
                    <span class="action collapse">
            Tampilkan
                    </span>
            ...
            Waktu eksekusi kueri
                            ...
                            <span class="query">SELECT * FROM `order_list`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="pet_shop_db" targettable="orders">
                            <div class="action_content">
                    <span class="action collapse">
            Tampilkan
                    </span>
            ...
            Waktu eksekusi kueri
                            ...
                            <span class="query">SELECT * FROM `inventory`</span>
                                            ...
                                            <div class="message history collapsed hide select"
                            targetdb="pet_shop_db" targettable="clients">
                            <div class="action_content">
                    <span class="action collapse">
            Tampilkan
                    </span>
            ...
            Waktu eksekusi kueri
                            ...
                            <span class="query">SELECT * FROM `clients`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="pet_shop_db" targettable="inventory">
                            <div class="action_content">
            ...
            Waktu eksekusi kueri
                            ...
                            <span class="query">SELECT * FROM `inventory`  
ORDER BY `inventory`.`unit` ASC</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="pet_shop_db" targettable="inventory">
                            <div class="action_content">
            ...
            Waktu eksekusi kueri
                            ...
                            <span class="query">SELECT * FROM `inventory`  
ORDER BY `inventory`.`price` ASC</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="pet_shop_db" targettable="inventory">
                            <div class="action_content">
            ...
            Waktu eksekusi kueri
                            ...
                            <span class="query">SELECT * FROM `inventory`  
ORDER BY `inventory`.`price`  DESC</span>
                        </div>
                                            <div class="message history collapsed hide"
                            targetdb="yosan" targettable="">
                            <div class="action_content">
                    <span class="action collapse">
            Tampilkan
                    </span>
            ...
            Waktu eksekusi kueri
                            ...
                            <span class="query">/*!40101 SET COLLATION_CONNECTION=@OLD_COLLATION_CONNECTION */;</span>
                                            ...
                                            <div class="message history collapsed hide select"
                            targetdb="yosan" targettable="user">
                            <div class="action_content">
                    <span class="action collapse">
            Tampilkan
                    </span>
            ...
            Waktu eksekusi kueri
                            ...
                            <span class="query">INSERT INTO `user` (`id_user`, `email`, `username`, `nim`, `password`) VALUES (NULL, &#039;farewap@gmail.com&#039;, &#039;karinasimp&#039;, &#039;1234512345&#039;, &#039;admin&#039;);</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="yosan" targettable="user">
                            <div class="action_content">
            ...
            Waktu eksekusi kueri
                            ...
                            <span class="query">SELECT * FROM `user`  
ORDER BY `user`.`password` ASC</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="yosan" targettable="user">
                            <div class="action_content">
            ...
            Waktu eksekusi kueri
                            ...
                            <span class="query">SELECT * FROM `user`  
ORDER BY `user`.`password`  DESC</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="yosan" targettable="user">
                            <div class="action_content">
            ...
            <span>Tambah bookmark</span>
                    ...
                    <div class="content add_bookmark">
                        <div class="options">
                            ...
                            <label>
                                Basis data target: <input type="text" name="targetdb">
                            </label>
                            <label>
                                <input type="checkbox" name="shared">Bagikan bookmark                            </label>
                            <button class="btn btn-primary" type="submit" name="submit">Oke</button>
                        </div> <!-- options -->
                        <div class="query_input">
